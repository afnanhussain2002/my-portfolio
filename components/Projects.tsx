      ...
      >
        {projects.map((project) => (
          <a href={project.link} target="_blank" key={project.id}>
            <div className=" flex flex-col items-center justify-center text-left w-96 border p-4 rounded-md cursor-pointer hover:animate-shimmer">
              ...
              <p className="font-light text-sm line-clamp-2">{project.des}</p>
                  ...
                  {project.iconLists.map((icon, index) => (
                    ...
                    >
                      <img
                        src={icon}
                        alt="icon5"
                        className="p-2 hover:scale-150 hover:rotate-12"
                      />
                    </div>
                  ))}
                </div>
